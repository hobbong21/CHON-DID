  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.iscoped, iscoped) || other.iscoped == iscoped));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, accessToken, refreshToken,
      expiresIn, refreshExpiresIn, tokenType, sessionState, iscoped);

  @override
  String toString() {
    return 'LoginModel(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn, refreshExpiresIn: $refreshExpiresIn, tokenType: $tokenType, sessionState: $sessionState, iscoped: $iscoped)';
  }
}
    ...
    return _then(_self.copyWith(
      ...
      sessionState: freezed == sessionState
          ...
          : sessionState // ignore: cast_nullable_to_non_nullable
              as String?,
      iscoped: freezed == iscoped
          ? _self.iscoped
          : iscoped // ignore: cast_nullable_to_non_nullable
              as String?,
    ));
  }
}
...
class _LoginModel implements LoginModel {
  const _LoginModel(
      ...
      @JsonKey(name: 'scope') this.iscoped});
