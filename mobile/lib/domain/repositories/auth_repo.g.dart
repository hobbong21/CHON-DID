...
class _AuthRepo implements AuthRepo {
  _AuthRepo(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<LoginModel> refreshToken({
    ...
    String clientId = "cms-parking",
    String clientSecret = "LN1LjiodrgAeKi071TAPjHZLoCdjI0Ob",
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'kUnauth': unauth};
