...
mixin _$LoginState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoading, messageError, isObscureText);

  @override
  String toString() {
    return 'LoginState(isLoading: $isLoading, messageError: $messageError, isObscureText: $isObscureText)';
  }
}
...
abstract mixin class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, String messageError, bool isObscureText});
}
...
extension LoginStatePatterns on LoginState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLoading, String messageError, bool isObscureText)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LoginState() when $default != null:
        return $default(
            _that.isLoading, _that.messageError, _that.isObscureText);
      case _:
        return orElse();
    }
  }
